...
import {getOrders, fetchOrdersInProgress} from "../../redux/actions/orderActions";
...
class Orders extends Component {
    ...
    render() {
        ...
        const {orders, orderRelatedStores, fetchingOrdersInProgress} = this.props.orderReducer;
        ...
        return (
            <div className="orders-parent">
                ...
                {
                    fetchingOrdersInProgress &&
                        <div className="orders-container">
                            <Loader loading={fetchingOrdersInProgress} color="#295454" size={15}/>
                        </div>
                }
                {
                    !fetchingOrdersInProgress &&
...
export const mapDispatchToProps = (dispatch) => {
    return {
        ...
        fetchOrdersInProgress: () => dispatch(fetchOrdersInProgress()),
    }
};
